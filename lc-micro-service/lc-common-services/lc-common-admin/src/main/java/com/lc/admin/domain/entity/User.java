...
public class User extends BaseFullEntity {
    ...
    @TableField(value = "mobile", el = "mobile, typeHandler=com.lc.data.mybatis.handler.DataSecurityTypeHandler")
    private String mobile;

    @ApiModelProperty(value = "邮箱")
    @TableField(value = "email", el = "email, typeHandler=com.lc.data.mybatis.handler.DataSecurityTypeHandler")
